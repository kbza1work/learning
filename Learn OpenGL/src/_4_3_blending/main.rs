...
const SRC_FOLDER: &'static str = "_4_3_blending";
const WINDOW_NAME: &'static str = "Learn OpenGL Lesson 4.3 Blending";
...
pub fn main() {
    ...
    let lights = vec![
        Light {
            position: Vector4::new(-1.0, -2.0, -1.0, 0.0),
    ...
    scene_graph.add_element(Box::new(Grass::new(SRC_FOLDER)));
