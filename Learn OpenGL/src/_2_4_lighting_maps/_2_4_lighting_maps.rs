...
const SRC_FOLDER: &'static str = "_2_4_lighting_maps";
const WINDOW_NAME: &'static str = "Learn OpenGL Lesson 2.4 Lighting Maps";
...
pub fn main() {
    ...
    scene_graph.add_element(Box::new(ContainerCube::new(SRC_FOLDER, cube_positions)));
